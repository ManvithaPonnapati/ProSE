...
@app.function(image=image, gpu=gpu_config, timeout=30000)
def get_msa(sequence: str) -> list:
    """
    Get the MSA for a given sequence using mmseqs2.

    Args:
        sequence: The sequence for which the MSA is to be generated.
    """
    user_agent = "modalcolabfold"
    return run_mmseqs2(
        x=sequence,
        prefix="msa",
        use_env=True,
